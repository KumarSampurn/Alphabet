...
def alpha():
    ...
    def letter_A():
        ...
        #captured_image=cv2.imread(r"C:\Users\KUMAR SAMPURN\Documents\Kodikon\database\Sample.jpeg")
    ...
    def letter_C():
        ...
        test_img=cv2.imread(r"C:\Users\KUMAR SAMPURN\Documents\Kodikon\database\C.jpeg")
        capture_image()
        captured_image=cv2.imread("captured_image_greyscale-final.jpg")
        #captured_image=cv2.imread(r"C:\Users\KUMAR SAMPURN\Documents\Kodikon\database\bad_A.jpeg")
        #added a c module
    ...
    a = Button(text=" Alphabets 'A' " , command= letter_A)
    a.pack(pady=10, padx=5 , fill='x')
    b = Button(text=" Alphabets 'B' " , command= letter_B)
    b.pack(pady=10, padx=5 , fill='x')
    c = Button(text=" Alphabets 'C' " , command= letter_C)
    c.pack(pady=10, padx=5 , fill='x')
...
def main():
    ...
    write_alpha = Button(text="Write Alphabets" , command= alpha)
    write_alpha.pack(pady=10, padx=5 , fill='x')
    pronouncing_alpha =Button(text="Pronouncing Alphabets" , command= ())
    pronouncing_alpha.pack(pady=10, padx=5 , fill='x')
    win.mainloop()
